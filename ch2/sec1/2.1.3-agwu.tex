...
\begin{lemma}
	Suppose we have isomorphic pairs of functors $\func{F,G}{\sC}{\sD}$, $\func{H_{0}, H_{1}}{\sD}{\sE} $, and $\func{K_{0},K_{1}}{\sB}{\sC}$ then $$ H_{0}F \cong H_{1}G\AND FK_{0} \cong GK_{1}.$$
...
\begin{proof}
	...
	The dual cases of (i) and (ii) follow from changing $\sC$ and $\sD$ to their respective opposite category. 
